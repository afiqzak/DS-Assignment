...
public class GoldenGalleon extends SilverSnitch{
    ...
    public double getPercentageTypeForCurrentMonth(String type) {
        return getTypeSpendForCurrentMonth(type) / getTotalSpendForCurrentMonth() * 100;
    }
    
    public double getTotalSpendForCurrentMonth(){
        double total = 0.0;
    ...
    public double getTypeSpendForCurrentMonth(String type){
